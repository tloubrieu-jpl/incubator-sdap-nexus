...
def spark_driver(sc, latlon, nexus_tiles_spark, tile_service_factory, metrics_callback):
...
class LatitudeTimeHoffMoellerSparkHandlerImpl(BaseHoffMoellerSparkHandlerImpl):
    ...
    def calc(self, compute_options, **args):
        ...
        results = spark_driver(self._sc, self._latlon, nexus_tiles_spark, self._tile_service_factory, metrics_record.record_metrics)
